   ...
   // فرض: gsap و Swiper قبلاً لود شده‌اند
        ...
        on: {
          ...
          slideChangeTransitionStart(s) {
            ...
            gsap.fromTo(
              media,
              { scale: 1 },
              { scale: 1.02, duration: 4, ease: "power1.out" }
            );
          },
    ...
    <script>
      const projSwiper = new Swiper(".projects-swiper", {
        ...
        breakpoints: {
          ...
          1024: { slidesPerView: 3, spaceBetween: 24 }, // دسکتاپ: ۳ آیتم
        },
      });
    </script>
    ...
    <script>
      const servicesSwiper = new Swiper(".services-swiper", {
        ...
        breakpoints: {
          640: { slidesPerView: 1.5, spaceBetween: 24 }, // موبایل بزرگ
          768: { slidesPerView: 2.5, spaceBetween: 28 }, // تبلت
          1024: { slidesPerView: 3.5, spaceBetween: 32 }, // دسکتاپ: حداقل ۳ کارت
          1440: { slidesPerView: 4.5, spaceBetween: 36 }, // نمایش وسیع‌تر
        },
      });
    </script>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // =========== موبایل: ساخت تاگل برای آیتم‌های دارای زیرمنو ===========
  ...
  if (mobileMenu) {
    mobileMenu.querySelectorAll('li.menu-item-has-children').forEach((li) => {
      ...
      btn.type = 'button';
      btn.className = 'parent-toggle';
      btn.setAttribute('aria-expanded', 'false');

      // برای یکتایی کنترل (ARIA)
      ...
      // لینک والد را پنهان کن تا دو تا نشود
      if (a) a.style.display = 'none';
      li.insertBefore(btn, sub);

      btn.addEventListener('click', () => {
        const isOpen = sub.getAttribute('data-open') === 'true';
        // بستن سایر زیرمنوهای باز (اختیاری؛ اگر چندتا همزمان می‌خواهی باز باشد، این بلاک را حذف کن)
  ...
  // =========== دسکتاپ: باز/بسته با کلیک/کیبورد ===========
  document.querySelectorAll(".menu-desktop li.menu-item-has-children").forEach((li) => {
    ...
    function closeAll() {
      document.querySelectorAll(".menu-desktop .sub-menu.open").forEach((other) => {
        if (other !== dd) {
    ...
    trigger.addEventListener('click', (e) => {
      e.preventDefault(); // اگر می‌خواهی والد لینک شود، این خط را حذف و آیکن‌تاگل جدا بساز
    ...
    trigger.addEventListener('keydown', (e) => {
      ...
      if (e.key === 'Escape') { dd.classList.remove('open'); trigger.setAttribute('aria-expanded','false'); trigger.focus(); }
    });
  });

  document.addEventListener('click', (e) => {
    if (!e.target.closest('.menu-desktop li.menu-item-has-children')) {
      document.querySelectorAll(".menu-desktop .sub-menu.open").forEach((dd) => {
